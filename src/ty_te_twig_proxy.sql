create or replace type ty_te_twig_proxy force as object (
  c_ number(1, 0)
  , CONSTRUCTOR FUNCTION ty_te_twig_proxy ( SELF IN OUT NOCOPY ty_te_twig_proxy ) RETURN SELF AS RESULT
