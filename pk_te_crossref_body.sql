...
*/
function insert_loop_te( a_te ty_te ) return pls_integer AS
...
*/
function get_loop_te( a_id pls_integer ) return ty_te AS
BEGIN
...
*/
function delete_loop_te( a_id pls_integer ) return boolean AS
BEGIN
  if g_te_tbl.exists( a_id ) then
